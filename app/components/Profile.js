...
var base = Rebase.createClass('https://react-sample-nrotta.firebaseio.com');
  ...
  render() {
    ...
    return (
      <div className="row">
        ...
        <div className="col-md-4">
          <Notes username={username} notes={this.state.notes} addNote={this.handlerAddNote.bind(this)} />
        </div>
      </div>
    )
  }
